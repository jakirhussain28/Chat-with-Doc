 ...
 */
export const sendChatMessage = (message, userId, conversationId = null, model = null) =>
    fetch(`${API_URL}/api/chat`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        // Add the 'model' to the payload
        body: JSON.stringify({ message, user_id: userId, conversation_id: conversationId, model }),
    });
