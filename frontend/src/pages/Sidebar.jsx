...
export default function Sidebar({ isOpen, toggleSidebar, conversations = [], activeId, onSelect, onDelete, onNewChat, onOpenProfile }) {
  return (
    <aside
    ...
    >
      ...
      {/* Profile section at the bottom - Updated with onClick */}
